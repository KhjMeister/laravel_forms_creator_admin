      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <!-- <li class="nav-item">
              <a class="nav-link" href="#">{{ __('message.aboutUs') }}</a>
            </li> -->
            <li class="nav-item">
              <a class="nav-link" href="{{ route('cuntactus') }}"  >{{ __('message.contactUs') }}</a>
            </li>
      ...
      <div class="row text-center">
        <div class="col-lg-3">
          <h5 class="mt-4 fw-bold">
            رایان لاین </h5>
            <p class="mt-3 mr-5 section1-footer">
              
              اطلس جامع نیازهای نیروی منابع استانی و صنعتی 
            </p>
        ...
        <div class="col-lg-3">
          ...
          <li >آدرس: زاهدان،پارک علم وفناوری</li>
          <li>آدرس ایمیل: rayanline@info.com</li>
          <li>شماره تماس: 05433333333</li>
        </div>
      </div>
    </div>
