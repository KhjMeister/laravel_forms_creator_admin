...
function make_input_field(el){
	...
	var input = '<div class="cnt_input_box form-group">';
		...
		input += '<span class="field_title" contenteditable>سوال تشریحی [ویرایش]</span>';
		input += in_field_edit;
		input += '</label>';
...
function make_textarea_field(el){
	...
	var input = '<div class="cnt_input_box form-group">';
		...
		input += '<span class="field_title" contenteditable>تشریحی با جواب بلند [ویرایش]</span>';
		input += in_field_edit;
		input += '</label>';
...
function make_select_field(el){
	...
	var input = '<div class="cnt_input_box form-group">';
		...
		input += '<span class="field_title" contenteditable>Select Field [ویرایش]</span>';
		input += in_field_edit;
		input += '</label>';
...
function make_checkbox_field(el){
	...
	var input = '<div class="cnt_input_box form-group">';
		...
		input += '<span class="field_title" contenteditable>Checkbox Field [ویرایش]</span>';
		input += in_field_edit;
		input += '</label>';
...
function make_radio_field(el){
	...
	var input = '<div class="cnt_input_box form-group">';
		...
		input += '<span class="field_title" contenteditable>Radio Field [ویرایش]</span>';
		input += in_field_edit;
		input += '</label>';
